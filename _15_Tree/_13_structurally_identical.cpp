...
// The first line of input contains data of the nodes of the first tree in level order form. The order is: 
...
// The order is: data for root node, number of children to root node, data of each of child nodes and so on and 
// so forth for each node. The data of the nodes of the tree is separated by space.
