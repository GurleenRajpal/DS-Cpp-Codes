// Ninja Factor
// Send Feedback
// Ninja is given an array of integers of size N and Q queries, each query will be consists of two integers l,
// r and ninja is supposed to calculate the number of i such that the ninja factor of array[i] is a prime number where l <= i <= r
...
int main(){
    ...
    //find all totient function values
    ...
    while(q--){
        int l, r;
        cin>>l>>r;
        //number of primrs b/w v[r-1] and v[l-1]
