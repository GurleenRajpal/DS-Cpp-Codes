...
// Query on range:
// You are given two numbers i and j; the answer to each query is the minimum number between the 
// range (i, j) (including both i and j). Note that in this query, i and j lies in the range: [1, N].
// Update query:
...
// Next, Q lines contain the queries. Each line contains one character, followed by two space-separated integers. For 
// the query on range, the character will be q and for the update query, the character will be u. 
// Constraints:
// 1 ≤ i ≤ N
// 0 ≤ B ≤ 10^8
// 1 ≤ i <= j ≤ N
