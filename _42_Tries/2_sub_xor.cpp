//  Sub - XOR
// Send Feedback
// Given an array of positive integers, you have to print the number of subarrays whose XOR 
// is less than K. Subarrays are defined as a sequence of continuous elements Ai, Ai + 1, ..., Aj. 
